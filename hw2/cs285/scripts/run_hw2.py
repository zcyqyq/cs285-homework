...
def run_training_loop(args):
    ...
    for itr in range(args.n_iter):
        ...
        trajs, envsteps_this_batch = sample_trajectories(env, agent.actor, args.batch_size, max_ep_len)  # TODO
        ...
        action = trajs_dict["action"]
        reward = trajs_dict["reward"]
        terminal = trajs_dict["terminal"]
        train_info = agent.update(obs, action, reward, terminal)
