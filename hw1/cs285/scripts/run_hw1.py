...
def run_training_loop(params):
    ...
    for itr in range(params['n_iter']):
        ...
        for _ in range(params['num_agent_train_steps_per_iter']):
          ...
          ob_batch = replay_buffer.obs[indices] #torch.from_numpy(replay_buffer.obs[indices]).float().to(ptu.device)
          ac_batch = replay_buffer.acs[indices] #torch.from_numpy(replay_buffer.acs[indices]).float().to(ptu.device)
